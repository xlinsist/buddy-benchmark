...
void _mlir_ciface_conv2d_nchw_fchw_vector_1(MemRef<float, 4> *input,
                                            MemRef<float, 4> *filter,
                                            MemRef<float, 4> *output);
void _mlir_ciface_conv2d_nchw_fchw_vector_2(MemRef<float, 4> *input,
                                            MemRef<float, 4> *filter,
                                            MemRef<float, 4> *output);
void _mlir_ciface_conv2d_nchw_fchw_vector_4(MemRef<float, 4> *input,
                                            MemRef<float, 4> *filter,
                                            MemRef<float, 4> *output);
...
void _mlir_ciface_conv2d_nchw_fchw_vector_128(MemRef<float, 4> *input,
                                              MemRef<float, 4> *filter,
                                              MemRef<float, 4> *output);
void _mlir_ciface_conv2d_nchw_fchw_im2col_vector_1(MemRef<float, 4> *input,
                                                   MemRef<float, 4> *filter,
                                                   MemRef<float, 4> *output);
void _mlir_ciface_conv2d_nchw_fchw_im2col_vector_2(MemRef<float, 4> *input,
                                                   MemRef<float, 4> *filter,
                                                   MemRef<float, 4> *output);
void _mlir_ciface_conv2d_nchw_fchw_im2col_vector_4(MemRef<float, 4> *input,
                                                   MemRef<float, 4> *filter,
                                                   MemRef<float, 4> *output);
...
#define RUN_BENCHMARK(name, func)                                              \
  ...
  DEFINE_BENCHMARK(name##Vector1, func##_vector_1)                             \
  BENCHMARK(name##Vector1)->Unit(benchmark::kMillisecond);                     \
  DEFINE_BENCHMARK(name##Vector2, func##_vector_2)                             \
  BENCHMARK(name##Vector2)->Unit(benchmark::kMillisecond);                     \
  DEFINE_BENCHMARK(name##Vector4, func##_vector_4)                             \
  BENCHMARK(name##Vector4)->Unit(benchmark::kMillisecond);                     \
  ...
  DEFINE_BENCHMARK(name##Im2colVector1, func##_im2col_vector_1)                \
  BENCHMARK(name##Im2colVector1)->Unit(benchmark::kMillisecond);               \
  DEFINE_BENCHMARK(name##Im2colVector2, func##_im2col_vector_2)                \
  BENCHMARK(name##Im2colVector2)->Unit(benchmark::kMillisecond);               \
  DEFINE_BENCHMARK(name##Im2colVector4, func##_im2col_vector_4)                \
  BENCHMARK(name##Im2colVector4)->Unit(benchmark::kMillisecond);               \
