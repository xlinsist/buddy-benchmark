...
void _mlir_ciface_matmul(MemRef<float, 2> *A, MemRef<float, 2> *B,
                         MemRef<float, 2> *C);
void _mlir_ciface_matmul_vector_1(MemRef<float, 2> *A, MemRef<float, 2> *B,
                                  MemRef<float, 2> *C);
void _mlir_ciface_matmul_vector_2(MemRef<float, 2> *A, MemRef<float, 2> *B,
                                  MemRef<float, 2> *C);
void _mlir_ciface_matmul_vector_4(MemRef<float, 2> *A, MemRef<float, 2> *B,
                                  MemRef<float, 2> *C);
